...
public class ReaderExtensionsBenchmark
{
    ...
    public async Task Before()
    {
        ...
        while (true)
        {
            ...
            try
            {
                if (!buffer.IsEmpty)
                {
                    if (ReaderExtensions_Before.TryDecode(_mqttPacketFormatter, buffer, out _, out consumed, out observed, out _))
                    {
                        break;
                    }
                }
    ...
    static class ReaderExtensions_Before
    {
        ...
        {
            // Algorithm taken from https://docs.oasis-open.org/mqtt/mqtt/v3.1.1/errata01/os/mqtt-v3.1.1-errata01-os-complete.html.
            var multiplier = 1;
            var value = 0;
            byte encodedByte;
            var index = 1;
