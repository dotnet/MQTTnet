...
namespace MQTTnet.Benchmarks
{
    ...
    {
        [Benchmark]
        public async Task Synchronize_100_Tasks_New()
        {
        ...
        [Benchmark]
        public async Task Synchronize_100_Tasks_Old()
        {
            const int tasksCount = 100;

            var tasks = new Task[tasksCount];
            var asyncLock = new AsyncLockOld();
            var globalI = 0;
        ...
        [Benchmark]
        public async Task Wait_100_000_Times_New()
        {
            var asyncLock = new AsyncLock();
        ...
        [Benchmark]
        public async Task Wait_100_000_Times_Old()
        {
            var asyncLock = new AsyncLockOld();
